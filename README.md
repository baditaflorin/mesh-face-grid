...
**Live → https://baditaflorin.github.io/mesh-face-grid/**

**Source → https://github.com/baditaflorin/mesh-face-grid**
...
git clone https://github.com/baditaflorin/mesh-face-grid
cd mesh-face-grid
npm install
npm run dev
```
...
- `mesh-face-grid:signalingUrl`
- `mesh-face-grid:turnTokenUrl`
- `mesh-face-grid:iceServers`
- `mesh-face-grid:room`
